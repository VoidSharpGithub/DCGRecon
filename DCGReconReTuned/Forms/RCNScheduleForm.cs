...
namespace DCGReconReTuned.Forms
{
    public partial class RCNScheduleForm : Form
    {
        ...
        private void Tuner1SetChannelButton_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show($"Are you sure you would like to set {Receiver.ReceiverName}, Tuner 1 to channel {RCNObj.DishChannel}?", "DCG Recon", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
        ...
        private void Tuner2SetChannelButton_Click(object sender, EventArgs e)
        {
            ...
            RCNSimulcastScheduleObject RCNObj = RCNScheduleDataGridView.SelectedRows[0].DataBoundItem as RCNSimulcastScheduleObject;
            ReceiverObject Receiver = OwnerForm.SelectedReceiver;
            if (MessageBox.Show($"Are you sure you would like to set {Receiver.ReceiverName}, Tuner 2 to channel {RCNObj.DishChannel}?", "DCG Recon", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
