    ...
    public partial class ConfigReceiverListForm : Form
    {
        ...
        private void ConfigReceiverListForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (ReceiverMgmtDataGridView.Rows.Count <= 0 && DialogResult != DialogResult.OK)
            {
                ...
                {
                    MessageBox.Show("Can not continue without receivers. Please add a receiver to monitor.", "DCG Recon", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                    e.Cancel = true;
                }
            ...
            {
                MessageBox.Show("Can not save without receivers. Please add a receiver to monitor.", "DCG Recon", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                e.Cancel = true;
            }
