...
namespace DCGRecon.Classes
{
    public class ReconUtilities
    {
        ...
        private static async Task<XDocument> GetTunerStats(string ipaddress, int tuner)
        {
            StringBuilder aStringBuilder = new StringBuilder();
            aStringBuilder.Append("<s:Envelope xmlns:s=\"http://schemas.xmlsoap.org/soap/envelope/\" s:encodingStyle=\"http://schemas.xmlsoap.org/soap/encoding/\">");
            aStringBuilder.Append("<s:Body>");
        ...
        private static async Task<XDocument> GetChannelStats(string ipaddress, int tuner)
        {
            StringBuilder aStringBuilder = new StringBuilder();
            aStringBuilder.Append("<s:Envelope xmlns:s=\"http://schemas.xmlsoap.org/soap/envelope/\" s:encodingStyle=\"http://schemas.xmlsoap.org/soap/encoding/\">");
            aStringBuilder.Append("<s:Body>");
        ...
        private static async Task<XDocument> GetSystemStats(string ipaddress)
        {
            StringBuilder aStringBuilder = new StringBuilder();
            aStringBuilder.Append("<s:Envelope xmlns:s=\"http://schemas.xmlsoap.org/soap/envelope/\" s:encodingStyle=\"http://schemas.xmlsoap.org/soap/encoding/\">");
            aStringBuilder.Append("<s:Body>");
